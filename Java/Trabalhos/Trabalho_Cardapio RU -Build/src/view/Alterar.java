...
public class Alterar extends  JFrame implements ActionListener {
    ...
    Alterar(){
        ...
        tfproteina.setText(cliente.vetproteina[dia_semana]);
        tfvegano.setText(cliente.vetvegano[dia_semana]);
        tfsalada.setText(cliente.vetsalada[dia_semana]);
        tffruta.setText(cliente.vetfruta[dia_semana]);
        tfsuco.setText(cliente.vetsuco[dia_semana]);
    ...
    // Usando Buider para alterar cliente
    private void salvarCliente(){
        
    Cliente builder = new Cliente.ClienteBuilder()
            .altdia(dia_semana)
            .altproteina(tfproteina.getText())
            .altvegano(tfvegano.getText())
            .altsalada(tfsalada.getText())
            .altfruta(tffruta.getText())
            .altsuco(tfsuco.getText())
            .builder();
    }
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == BtSalvar){
            salvarCliente();
            JOptionPane.showMessageDialog(null,"Cardapio da " + cliente.vetdia[dia_semana] + " cadastrado com sucesso");
